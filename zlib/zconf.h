...
// OpenNURBS build with warning level /W4
// The following pragma is needed to supress dozens of warning
...
// OpenNURBS requires zlib to be compiled with -DZ_PREFIX and -DMY_ZCALLOC
#if !defined(Z_PREFIX)
